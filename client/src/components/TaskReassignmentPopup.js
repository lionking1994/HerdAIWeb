...
const TaskReassignmentPopup = ({ isOpen, onClose, taskId, currentAssignee, onAssigneeChange, meetingId, myTaskDetail }) => {
          ...
          >
            <div className="p-3">
              ...
              <div className="flex items-center justify-between mb-3">
                <h2 className="text-base font-semibold text-gray-900">Reassign Task</h2>
                <button
                  onClick={onClose}
              ...
              {currentAssignee && (
                <div className="mb-3">
                  <p className="text-xs text-gray-500 mb-1.5">Current Assignee</p>
                  <div className="p-2 bg-blue-50 rounded-lg border border-blue-100">
                    <p className="font-medium text-blue-800 text-sm">{currentAssignee}</p>
                  </div>
                </div>
              )}
