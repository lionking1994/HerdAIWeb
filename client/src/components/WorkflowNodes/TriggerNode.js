    ...
    const fetchMeetingDetails = async () => {
        try {
          ...
          const { data: meetingData } = await axios.get(
            ...
            {
              params: { meetingId: data.meeting_id },
              headers: {
    ...
    <div className="p-6">
      ...
      <div>
        ...
        <div className="mb-6 bg-gray-50 p-4 ">
            <a href={`/meeting_details?id=${meeting.id}`} className="rounded-lg cursor-pointer hover:text-blue-500">
