...
const ProjectsDashboard = () => {
  ...
  const fetchProjects = async () => {
    try {
      ...
      const { projects: projectsData } = response.data.data
  ...
  // Calculate pagination based on projects
  const totalPages = Math.ceil(projects.length / pagination.pageSize);
    ...
    <div className="h-full flex flex-col">
      <div className="flex-1 space-y-3 overflow-y-auto overflow-x-hidden pr-1">
        ...
        <div className="bg-gray-50/30 flex-1 overflow-auto">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-600 text-center mb-4">
                You don't have any user stories assigned to projects yet.
              </p>
            </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 
                          className="font-normal text-purple-500 underline text-lg cursor-pointer hover:text-purple-700"
          ...
          {/* Footer - only show when there are projects */}
          {projects.length > 0 && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <p className="text-xs text-gray-400 text-center mt-1">
                Total Stories: {projects.reduce((sum, project) => sum + project.assigned_stories_count, 0)}
              </p>
            </div>
          )}
        </div>
      ...
      {projects.length > 0 && (
        <div className="flex items-center justify-between px-4 py-3 bg-white rounded-lg mt-0 border-t border-gray-200">
          ...
          <div className="flex-1 text-sm text-gray-700">
            Showing {startItem} to {endItem} of {projects.length} results
          </div>
