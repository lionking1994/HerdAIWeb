...
function SortableDocumentItem({ document, index, onDelete, canEdit }) {
    ...
    >
      <div className="flex items-center space-x-3">
        ...
        <div className="flex items-center space-x-2">
          <a
            href={`${process.env.REACT_APP_API_URL}${document.file_url}`}
            target="_blank"
...
export function DocumentList({ documents, onReorder, onDelete, canEdit = false }) {
