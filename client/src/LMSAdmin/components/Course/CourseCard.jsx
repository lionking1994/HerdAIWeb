    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="aspect-video bg-gradient-to-br from-indigo-500 to-purple-600 relative">
        {course.thumbnail_url ? (
          ...
          <div className="w-full h-full flex items-center justify-center" >
            <Link to={`/lms/courses/${course.id}`} className="text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors text-sm font-medium">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          <Link to={`/lms/courses/${course.id}`} className="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors text-sm font-medium">
